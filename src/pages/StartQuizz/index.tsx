...
const StartQuizz: React.FC = () => {
  return (
    <div className="pt-8">
        <Typography variant="h4" className="text-center">Introduction to the websie</Typography>
        <Typography variant="h4" className="text-center">---------------------------</Typography>
        <Typography variant="h4" className="text-center">---------------------------</Typography>
        <Typography variant="h4" className="text-center">---------------------------</Typography>
        <Typography variant="h4" className="text-center">---------------------------</Typography>
        <Typography variant="h4" className="text-center">Information about the technologies</Typography>
        <Typography variant="h4" className="text-center">---------------------------</Typography>
        <Typography variant="h4" className="text-center">---------------------------</Typography>
        <Typography variant="h4" className="text-center">---------------------------</Typography>
        <Typography variant="h4" className="text-center">---------------------------</Typography>
    ...
    <Grid container spacing={2}> {/* Adjust spacing as needed */}
      {cardData.map((data, index) => (
        <Grid item xs={12} sm={6} md={4} key={index}> {/* Adjust grid sizing as needed */}
          <CustomCard {...data} />
        </Grid>
      ))}
    </Grid>
