      ...
      <Fade in={animationReady} timeout={500}>
        <div className="landing-page-text">
          <Typography variant="h3">
            ...
            building your project. It&apos;s simple: choose the technologies you
            want to use and describe your project idea. A Learning Path will be
            generated for you, providing step-by-step instructions on what you
            need to learn and do in order to bring your idea to life
          </Typography>
        </div>
      </Fade>
      <div className="flex justify-center gap-1 pt-20">
        {learningPath.length > 0 && (
          <Link to={"/learningpath"}>
            <Fade in={animationReady} timeout={500}>
              <button className="landing-page-button relative inline-flex items-center justify-start px-6 py-3 overflow-hidden font-medium transition-all bg-costum group border-black border-2 rounded-l-xl hover:bg-white hover:border-black">
        ...
        <Link to={"/guide"}>
          <Fade in={animationReady} timeout={500}>
            <button className="landing-page-button relative inline-flex items-center justify-start px-6 py-3 overflow-hidden font-medium transition-all bg-costum hover:bg-white group border-black border-2 hover:border-black rounded-r-xl">
